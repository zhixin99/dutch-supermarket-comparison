...
export default function HomePage() {
  ...
  // ================= Render =================
  return (
    <main className="max-w-6xl mx-auto px-6 pb-10 pt-20 space-y-6">
      {/* Title */}
      ...
      {/* Search Panel */}
      <section className="w-full rounded-3xl backdrop-blur-xl bg-white/40 shadow-lg px-6 py-8 space-y-6">
